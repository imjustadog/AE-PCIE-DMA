//$Header: /devl/xcs/repo/groups/3gio/ep/xilinx_3gio_endpoint/rtl/BMD/sw/mb_validation_sw/xbmd_combined/xbmd/MersenneTwister.h,v 1.1 2008/10/22 20:27:59 jakew Exp $
// MersenneTwister.h
...
{
	// time() and clock()
	uint32 seed_value =  hash(time(NULL), clock());
